#!/usr/bin/env python3
# Where: tools/python_cli/main.py
...
def main():
    ...
    from tools.python_cli.commands import build, down, init, logs, node, reset, stop, up
    from tools.python_cli.core import context, help_text
