...
const file_agent_proto_rawDesc = "" +
	...
	"\fInvokeWorker\x12!.esb.agent.v1.InvokeWorkerRequest\x1a\".esb.agent.v1.InvokeWorkerResponseB6Z4github.com/poruru-code/esb/services/agent/pkg/api/v1b\x06proto3"
