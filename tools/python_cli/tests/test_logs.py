# Where: tools/python_cli/tests/test_logs.py
...
from tools.python_cli.commands import logs


@patch(
    "tools.python_cli.compose.runtime_mode.get_mode", return_value=cli_config.ESB_MODE_CONTAINERD
)
