...
require_path "tools/bootstrap/cloud-init/user-data.template.yaml"
require_path "tools/bootstrap/core/render-user-data.psm1"
require_path "tools/bootstrap/wsl/create-instance.ps1"
require_path "tools/bootstrap/hyper-v/create-instance.ps1"
