// Where: tools-go/internal/generator/go_builder_test.go
...
import (
	...
	"github.com/poruru/edge-serverless-box/tools-go/internal/app"
...
func TestGoBuilderBuildGeneratesAndBuilds(t *testing.T) {
	...
	writeTestFile(t, filepath.Join(repoRoot, "tools", "generator", "runtime", "Dockerfile.base"), "FROM scratch\n")
