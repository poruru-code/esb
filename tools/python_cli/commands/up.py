# Where: tools/python_cli/commands/up.py
...
from tools.python_cli.core import context, logging, proxy
from tools.python_cli.core.cert import ensure_certs
...
def run(args):
    ...
    from tools.python_cli.core.port_discovery import (
        apply_ports_to_env,
        discover_ports,
        log_ports,
        save_ports,
    ...
    from tools.python_cli.config import TEMPLATE_YAML
