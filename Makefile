...
GATEWAY_IMAGE ?= $(IMAGE_REGISTRY)$(BRAND_SLUG)-gateway-docker:$(IMAGE_TAG)
GATEWAY_FC_IMAGE ?= $(IMAGE_REGISTRY)$(BRAND_SLUG)-gateway-containerd:$(IMAGE_TAG)
AGENT_IMAGE ?= $(IMAGE_REGISTRY)$(BRAND_SLUG)-agent-docker:$(IMAGE_TAG)
AGENT_CONTAINERD_IMAGE ?= $(IMAGE_REGISTRY)$(BRAND_SLUG)-agent-containerd:$(IMAGE_TAG)
RUNTIME_NODE_IMAGE ?= $(IMAGE_REGISTRY)$(BRAND_SLUG)-runtime-node-containerd:$(IMAGE_TAG)
RUNTIME_NODE_FC_IMAGE ?= $(IMAGE_REGISTRY)$(BRAND_SLUG)-runtime-node-containerd:$(IMAGE_TAG)
