...
const (
	...
	EnvSkipGatewayAlign   = "SKIP_GATEWAY_ALIGN"
	EnvRegistryWait       = "REGISTRY_WAIT"
	EnvCliBin             = "CLI_BIN"
	EnvMetaReuse          = "META_REUSE"
	EnvBuildkitdOverwrite = "BUILDKITD_OVERWRITE"
	EnvBuildxNetworkMode  = "BUILDX_NETWORK_MODE"
	EnvPortS3             = "PORT_S3"
