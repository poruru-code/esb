...
MARKER = "# Auto-generated by buildx setup."
LEGACY_MANAGED_MARKERS = ("# Auto-generated by esb buildx setup.",)
MANAGED_MARKERS = (MARKER, *LEGACY_MANAGED_MARKERS)
...
def _resolve_buildkitd_path(repo_root: Path) -> Path:
    ...
    return _branding(repo_root).buildkitd_config_path(repo_root)
...
def _is_managed_config(content: str) -> bool:
...
def _write_config(path: Path, content: str) -> None:
    ...
    if path.exists():
        ...
        if not _is_managed_config(existing) and os.environ.get("ESB_BUILDKITD_OVERWRITE") != "1":
            print(
...
def main() -> int:
    ...
    builder_name = _branding(repo_root).buildx_builder_name(None)
