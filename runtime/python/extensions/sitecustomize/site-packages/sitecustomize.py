...
# --- Globals & Originals ---
if not hasattr(boto3, "_sitecustomize_original_client"):
    boto3._sitecustomize_original_client = boto3.client
_original_boto3_client = getattr(boto3, "_sitecustomize_original_client", boto3.client)
