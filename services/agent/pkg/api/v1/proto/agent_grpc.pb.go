...
func (c *agentServiceClient) EnsureContainer(ctx context.Context, in *EnsureContainerRequest, opts ...grpc.CallOption) (*WorkerInfo, error) {
	out := new(WorkerInfo)
	err := c.cc.Invoke(ctx, "/esb.agent.v1.AgentService/EnsureContainer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) DestroyContainer(ctx context.Context, in *DestroyContainerRequest, opts ...grpc.CallOption) (*DestroyContainerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/esb.agent.v1.AgentService/DestroyContainer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) PauseContainer(ctx context.Context, in *PauseContainerRequest, opts ...grpc.CallOption) (*PauseContainerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/esb.agent.v1.AgentService/PauseContainer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) ResumeContainer(ctx context.Context, in *ResumeContainerRequest, opts ...grpc.CallOption) (*ResumeContainerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/esb.agent.v1.AgentService/ResumeContainer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) ListContainers(ctx context.Context, in *ListContainersRequest, opts ...grpc.CallOption) (*ListContainersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/esb.agent.v1.AgentService/ListContainers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AgentService_EnsureContainer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/esb.agent.v1.AgentService/EnsureContainer",
	}
...
func _AgentService_DestroyContainer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/esb.agent.v1.AgentService/DestroyContainer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AgentService_PauseContainer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/esb.agent.v1.AgentService/PauseContainer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AgentService_ResumeContainer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/esb.agent.v1.AgentService/ResumeContainer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AgentService_ListContainers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/esb.agent.v1.AgentService/ListContainers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
