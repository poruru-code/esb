...
require_pattern "f\"mvn -s {M2_SETTINGS_PATH} -q -Dmaven.artifact.threads=1 -DskipTests package\"" "$PY_FILE"
require_pattern "mvn -s %s -q -Dmaven.artifact.threads=1 -DskipTests " "$GO_FILE"
