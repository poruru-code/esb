...
cp tools/bootstrap/wireguard/examples/gateway/wg0.conf.example <repo_root>/.<brand>/wireguard/gateway/wg0.conf
cp tools/bootstrap/wireguard/examples/compute/wg0.conf.example <repo_root>/.<brand>/wireguard/compute/wg0.conf
```
