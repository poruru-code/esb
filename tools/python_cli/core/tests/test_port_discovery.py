"""
Where: tools/python_cli/core/tests/test_port_discovery.py
...
class TestDiscoverPorts:
    ...
    def test_discover_ports_returns_dict(self):
        ...
        from tools.python_cli.core.port_discovery import discover_ports
...
class TestSavePorts:
    ...
    def test_save_ports_creates_json_file(self, tmp_path, monkeypatch):
        ...
        from tools.python_cli.core.port_discovery import save_ports
...
class TestLoadPorts:
    ...
    def test_load_ports_reads_json_file(self, tmp_path, monkeypatch):
        ...
        from tools.python_cli.core.port_discovery import load_ports
...
class TestApplyPortsToEnv:
    ...
    def test_apply_ports_sets_env_vars(self, monkeypatch):
        ...
        from tools.python_cli.core.port_discovery import apply_ports_to_env
